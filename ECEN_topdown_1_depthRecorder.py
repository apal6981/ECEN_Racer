...
try:
    ...
    depth_writer = cv.VideoWriter('depth_video_seba_D.avi', cv.VideoWriter_fourcc(*'MJPG'), 30, (rgb.shape[1], rgb.shape[0]), True)
    rgb_writer = cv.VideoWriter('rgb_video_seba_D.avi', cv.VideoWriter_fourcc(*'MJPG'), 30, (rgb.shape[1], rgb.shape[0]), True)
